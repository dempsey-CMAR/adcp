...
knitr::include_graphics("https://github.com/dempsey-CMAR/adcp/blob/main/man/figures/README-fig2.png")
...
knitr::include_graphics("https://github.com/dempsey-CMAR/adcp/blob/main/man/figures/README-fig3.png")
...
```{r, README-fig4, fig.height=3.5, dpi=600}
...
```{r, README-fig5, fig.height=3.5, dpi=600}
adcp_plot_depth(dat, geom = "line")

```
Plot current rose:
```{r, README-fig6, fig.height=3.5, dpi=600}
...
```{r, README-fig7, fig.height=3.5, dpi=600}
